              ...
              <div className={s.filterSection}>
                ...
                <div className={s.bhkGroup}>
                  {bhkOptions.map((opt) => (
                    <button
                      key={opt}
                      onClick={() => handleBhkSelect(opt)}
                      className={`${s.bhkButton} ${filters.bhk === opt ? s.bhkButtonActive : s.bhkButtonInactive}`}
                    >
                      {opt}
                    </button>
                  ))}
                  ...
                  {furnishingOptions.map((opt) => (
                    <label key={opt.value} className={s.checkboxLabel}>
                      <input
                        ...
                        onChange={() =>
                          handleCheckboxChange("furnishing", opt.value)
                        }
                        className={s.checkbox}
                      />
                      {opt.label}
          ...
          <main className={s.mainContent}>
            ...
            {loading ? (
              ...
              <div className={s.emptyContainer}>
                ...
                <p className={s.emptyText}>Expand your search criteria</p>
