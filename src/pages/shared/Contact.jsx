      ...
      <div className={s.mainContainer}>
        <div className={s.header}>
          ...
          <p className={s.subheading}>
            Got questions or feedback? We'd love to hear from you. Our team is
            here to assist you fully with anything you need.
          </p>
        </div>
            ...
            <div className={s.contactInfoCard}>
              <div className={`${s.contactItem} ${s.contactItemMarginBottom}`}>
                ...
                <div>
                  ...
                  <div className={s.contactDetail}>support@apexroot.com</div>
                </div>
              </div>
              ...
              <div className={s.contactItem}>
                ...
                <div>
                  ...
                  <div className={s.contactDetail}>+234 907-461-4559</div>
                </div>
              </div>
            </div>
                ...
                <div className={s.formTwoColGrid}>
                  ...
                  <div className={s.inputGroup}>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="ceejay4@example.com"
                      className={s.input}
                    />
                  </div>
                </div>
...
export default Contact; //12.02.19
