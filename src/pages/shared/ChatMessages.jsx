...
const ChatMessages = () => {
  ...
  const handleDelChat = async (e, chatId) => {
    e.stopPropagation();
  ...
  const handleDelMessage = async (chatId, messageId) => {
            ...
            {conversations.length === 0 ? (
              ...
              conversations.map((chat) => (
                ...
                >
                  ...
                  <button
                    onClick={(e) => handleDelChat(e, chat._id)}
                    ...
                    <div className={s.messageContent}>
                      ...
                      {(msg.sender?._id || msg.sender) === user._id && (
                        <button
                          ...
                          onClick={() =>
                            handleDelMessage(activeChat._id, msg._id)
                          }
