export const adminContactsStyles = {
  ...
  cardHeader: "border-b border-[#ECE6E1] p-6 flex justify-between items-center",
  ...
  contactItem: (index, total) =>
    `p-5 sm:p-8 bg-white transition-all duration-300 ease-in-out border-b ${index !== total - 1 ? "border-[#ECE6E1]" : "border-transparent"}`,
  contactHeader:
  ...
  messageBox:
    "bg-[#FCFAF8] p-4 sm:py-5 sm:px-6 rounded-2xl text-[0.95rem] leading-[1.6] text-[#334155] border border-[#ECE6E1]",
};
...
export const adminInquiriesStyles = {
  ...
  cardTopSection:
    "flex flex-col sm:flex-row justify-between items-start mb-6 border-b border-[#ECE6E1] pb-6 gap-4 sm:gap-4",
  ...
  detailCard: "bg-[#FCFAF8] p-4 md:p-5 rounded-2xl border border-[#ECE6E1]",
  detailLabel:
...
export const adminUsersStyles = {
  ...
  filterButton:
    "flex items-center gap-2 px-4 py-2.5 rounded-lg border border-border bg-white text-text-main shadow-sm hover:bg-[#FCFAF8] transition-all duration-200 cursor-pointer",
  filterDropdown:
    "absolute right-0 max-sm:left-0 max-sm:right-auto mt-2 w-44 rounded-xl border border-border bg-white shadow-lg z-20 overflow-hidden",
  filterOption: (isActive) =>
    `w-full text-left px-4 py-2.5 hover:bg-[#FCFAF8] ${isActive ? "font-semibold text-primary" : "text-text-main"}`,
  ...
  thead:
    "bg-[#FCFAF8] text-[#64748b] text-[0.7rem] font-bold uppercase tracking-[0.05em]",
  tableRow: "border-b border-[#ECE6E1]",
  ...
  blockButton: (isBlocked) =>
    `w-9 h-9 rounded-lg border border-border bg-white flex items-center justify-center cursor-pointer hover:bg-primary-light ${isBlocked ? "text-[#10b981]" : "text-[#f59e0b]"}`,
  deleteButton:
...
export const myInquiriesStyles = {
  ...
  iconContainer:
    "bg-[#FCFAF8] w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mx-auto mb-6 text-[#94a3b8]",
  ...
  buyerInfo:
    "flex flex-col md:flex-row gap-3 md:gap-6 mb-5 p-3 md:p-4 bg-[#FCFAF8] rounded-xl flex-wrap w-full",
  infoItem:
  ...
  message:
    "text-[#334155] text-[0.95rem] md:text-base italic mb-5 pl-3 border-l-[3px] border-border break-words",
  ...
  actions:
    "flex flex-col sm:flex-row lg:flex-col gap-3 w-full lg:w-[160px] lg:shrink-0 lg:ml-6 pt-4 lg:pt-0 border-t border-[#ECE6E1] lg:border-t-0 justify-center",
  btnOutline:
...
export const sellerRequestsStyles = {
  ...
  requestCard:
    "border border-[#ECE6E1] rounded-2xl p-6 bg-[#FCFAF8] transition-all duration-300 ease-in-out hover:-translate-y-1",
...
export const addPropertyStyles = {
  ...
  sectionBar: "w-5 h-3 bg-primary rounded-sm",
  ...
  // Inputs
  input:
    "w-full py-3.5 px-4 rounded-xl border border-border outline-none bg-white text-[0.9375rem] focus:border-primary transition-colors",
  ...
  amenityLabelInactive: "bg-[#FCFAF8] border-border",
  ...
  // Image upload
  uploadArea:
    "border-2 border-dashed border-[#cbd5e1] p-12 rounded-xl text-center cursor-pointer relative bg-[#FCFAF8] transition-colors hover:border-primary",
  ...
  previewItem:
    "relative aspect-square rounded-xl overflow-hidden border border-[#ECE6E1] shadow-sm",
  removeButton:
  ...
  addMoreBox:
    "aspect-square border-2 border-dashed border-[#cbd5e1] rounded-xl flex flex-col items-center justify-center cursor-pointer relative bg-[#FCFAF8] transition-colors hover:border-primary",
  addMoreText: "text-xs font-bold text-[#64748b] mt-1.5",

  // Footer buttons
  footerButtons:
    "mt-12 flex justify-center flex-wrap gap-5 border-t border-[#ECE6E1] pt-10",
...
export const editPropertyStyles = {
  ...
  input:
    "w-full py-3.5 px-4 rounded-xl border border-border outline-none bg-white text-[0.9375rem] focus:border-primary transition-colors",
  textarea:
    "w-full h-[120px] py-3.5 px-4 rounded-xl border border-border outline-none resize-none bg-white text-[0.9375rem] leading-relaxed focus:border-primary transition-colors",
  select:
    "w-full p-3.5 rounded-xl border border-border outline-none bg-white cursor-pointer focus:border-primary transition-colors",
  twoColumnGrid:
    "grid grid-cols-1 md:grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-8 mb-12",
  ...
  amenityLabel: (isSelected) =>
    `flex items-center gap-3 cursor-pointer p-3 rounded-xl border transition-all duration-200 ${isSelected ? "bg-primary-light border-primary" : "bg-[#FCFAF8] border-border"}`,
  amenityCheckbox: "accent-primary w-4 h-4",
  ...
  imageCard:
    "relative aspect-square rounded-xl overflow-hidden border-2 border-[#ECE6E1]",
  imageCardNew:
...
export const myPropertiesStyles = {
  ...
  emptyCard: "card-premium py-24 px-8 text-center",
  emptyIconWrapper:
    "bg-[#FCFAF8] w-[80px] h-[80px] rounded-full flex items-center justify-center mx-auto mb-8",
  ...
  select:
    "w-full py-2.5 pr-8 pl-3 text-[0.8125rem] font-semibold rounded-lg border border-border bg-white appearance-none cursor-pointer outline-none",
  ...
  editButton:
    "btn btn-outline p-2.5 text-[0.8125rem] flex items-center justify-center gap-1.5 border border-border",
  deleteButton:
...
export const sellerDashboardStyles = {
  ...
  statCard:
    "bg-white p-6 rounded-[1.25rem] border border-[#ECE6E1] shadow-[0_4px_20px_rgba(0,0,0,0.02)]",
  statIconWrapper:
  ...
  searchInput:
    "py-2.5 pr-4 pl-10 rounded-xl border border-border outline-none text-[0.875rem] w-full",
  ...
  inquiriesWidget:
    "bg-white rounded-3xl border border-[#ECE6E1] p-6 shadow-[0_4px_20px_rgba(0,0,0,0.02)]",
...
export const chatMessagesStyles = {
  ...
  // Chat wrapper
  chatWrapper:
    "flex flex-1 bg-[#FCFAF8] font-sans relative overflow-hidden mt-0 md:mt-0",

  // Sidebar
  sidebar:
    "w-full absolute inset-0 z-10 transition-transform duration-300 lg:relative lg:w-[350px] shrink-0 bg-white border-r border-border flex flex-col lg:translate-x-0",
  sidebarHidden: "-translate-x-full lg:-translate-x-0 hidden lg:flex",
  sidebarHeader: "p-5 border-b border-[#ECE6E1]",
  ...
  chatHeader:
    "p-[10px_15px] md:p-[15px_25px] bg-white sticky md:relative top-0 z-20 border-b border-border flex items-center justify-between",
  ...
  messagesArea:
    "p-[15px] pb-[80px] md:p-[25px] md:pb-[25px] overflow-y-auto flex-1 flex flex-col gap-[15px] bg-[#FCFAF8]",
  messageBubble:
  ...
  messageForm:
    "p-[12px_15px] md:p-[20px_25px] bg-white sticky md:relative bottom-0 border-t border-border flex gap-[15px] items-center",
  messageInput:
    "flex-1 min-w-0 border border-border rounded-[30px] p-[12px_25px] outline-none text-[0.95rem] transition-colors duration-200 focus:border-[#00b4d8]",
  sendButton:
...
export const contactStyles = {
  // Layout
  container: "min-h-screen bg-[#FCFAF8] pt-32 max-lg:pt-28",
  ...
  input:
    "w-full p-3 rounded-xl border border-border outline-none transition-colors focus:border-primary",
...
export const profileStyles = {
  ...
  infoIcon:
    "w-12 h-12 rounded-2xl bg-[#FCFAF8] flex items-center justify-center text-primary shrink-0",
...
export const landingPageStyles = {
  ...
  heroTitle:
    "hero-title text-[clamp(2rem,3vw,2.5rem)] mb-6 transition-all duration-300 max-lg:text-[clamp(1.75rem,8vw,2.5rem)] max-lg:leading-tight max-lg:text-center",
  ...
  // Search form
  searchForm:
    "glass search-form p-3 rounded-[2rem] flex items-center gap-4 shadow-[0_20px_40px_rgba(0,0,0,0.08)] max-w-[900px] border border-white/50 relative z-10 max-lg:flex-col max-lg:w-full max-lg:max-w-[500px] max-lg:mx-auto max-lg:gap-2 max-lg:rounded-[1.5rem]",
  searchField:
    "search-field flex-[1.2] flex items-center gap-2 py-1 px-2 transition-all duration-300 min-w-[220px] max-lg:w-full max-lg:py-4 max-lg:px-2 max-lg:border-b max-lg:border-[#ECE6E1]",
  ...
  searchButton:
    "btn btn-primary search-button h-[44px] min-w-[140px] rounded-[1rem] text-base font-bold shadow-[0_12px_24px_rgba(244,124,32,0.22)] flex items-center justify-center gap-2 max-lg:w-full max-lg:h-[56px] max-lg:rounded-2xl max-lg:mt-2",

  // Stats
  statsContainer:
    "stats-container flex gap-[clamp(1rem,3vw,4rem)] mt-10 max-lg:justify-center max-lg:gap-8 max-md:flex-wrap",
  ...
  imageWrapper:
    "rounded-[2rem] overflow-hidden shadow-[0_40px_80px_-20px_rgba(0,0,0,0.25)] relative",
  heroImage: "w-full h-[400px] object-cover",
  verifiedBadge:
    "glass absolute bottom-8 left-6 p-4 rounded-xl flex items-center gap-3 max-w-[300px]",
  badgeIconWrapper: "bg-primary-light p-3 rounded-full",
  badgeTitle: "text-[0.9375rem] font-bold",
  badgeText: "text-[0.75rem] text-text-muted",
  preApproved: "badge bg-primary/10 text-primary rounded-xl text-[0.625rem]",
  ...
  categoryCard:
    "category-card py-10 px-6 text-center cursor-pointer bg-white rounded-3xl border border-border transition-all duration-300 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05)] hover:-translate-y-2 hover:border-primary hover:shadow-[0_12px_25px_-5px_rgba(244,124,32,.15)] group max-sm:py-6 max-sm:px-4",
  categoryIconWrapper:
  ...
  featureCard:
    "fade-in feature-card-item p-8 bg-white rounded-3xl border border-border transition-all duration-300 flex flex-col items-start hover:border-primary hover:-translate-y-[5px] hover:shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05)]",
  featureIconWrapper:
  ...
  processSection: "py-15 bg-bg-main",
  ...
  featuredSection: "py-13 bg-bg-alt",
  ...
  discoverButton: "btn btn-primary py-4 px-12 rounded-xl",

  // Footer
  footer: "bg-white border-t border-border pt-24 pb-0",
  footerMainGrid:
  ...
  brandLogo:
    "flex items-center gap-2 w-46 sm:w-39 font-extrabold text-primary mb-6",
  brandIcon: "bg-primary-light/60 text-white py-1.5 px-2.5 rounded-xl text-base",
  ...
  newsletterInput:
    "w-full py-4 pr-[85px] pl-5 rounded-2xl border border-border bg-bg-alt outline-none text-[0.875rem] focus:border-primary transition-colors",
  newsletterButton:
    "btn btn-primary absolute right-1.5 top-1.5 bottom-1.5 px-5 rounded-xl text-[0.8125rem]",
  bottomBar:
    "border-t border-border py-8 flex flex-col gap-4 text-[0.875rem] text-text-muted",
  bottomBarFlex:
  ...
  designLink:
    "font-semibold text-primary hover:text-amber-700 hover:underline transition-colors duration-300",
};

export const propertiesStyles = {
  // Page container
  pageContainer: "bg-[#FCFAF8] min-h-screen pb-16 pt-32 max-lg:pt-28",
  container: "container",
  ...
  // Sidebar
  sidebar:
    "filters-sidebar scrollbar-hide bg-white rounded-[1.5rem] p-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)] max-h-[calc(100vh-120px)] overflow-y-auto sticky top-[100px] border border-[#ECE6E1] z-[90] max-[1024px]:fixed max-[1024px]:max-h-screen max-[1024px]:top-0 max-[1024px]:bottom-0 max-[1024px]:w-full max-[1024px]:max-w-[350px] max-[1024px]:rounded-none max-[1024px]:transition-[left] max-[1024px]:duration-300 max-[1024px]:ease max-[1024px]:z-[2005]",
  sidebarVisible: "max-[1024px]:left-0",
  sidebarHidden: "max-[1024px]:-left-full",
  sidebarHeader: "flex justify-between items-center mb-8 lg:mt-0 mt-10",
  sidebarTitleWrapper: "flex items-center gap-2",
  sidebarTitleIcon: "text-primary",
  sidebarTitle: "text-xl font-bold m-0",
  sidebarHeaderActions: "flex gap-9 items-center",
  resetButton:
    "bg-transparent border-none text-primary text-sm font-semibold cursor-pointer",
  closeMobileFilters:
    "mobile-close-filters hidden max-[1024px]:flex items-center justify-center text-red-600 text-2xl border-none p-2 rounded-full cursor-pointer",
  ...
  searchIcon: "absolute left-4 top-1/2 -translate-y-1/2 text-[#94a3b8]",
  searchInput:
    "w-full py-3 pr-4 pl-10 rounded-xl border border-border outline-none text-sm",
  ...
  bhkButton:
    "flex-1 min-w-[50px] p-2 rounded-lg text-sm font-bold cursor-pointer transition-all duration-200 border border-border bg-white text-[#64748b]",
  bhkButtonActive: "border border-primary bg-primary-light text-primary-dark",
  bhkButtonInactive: "border border-border bg-white text-[#64748b]",

  // Main content
  mainContent: "", // no extra classes
  contentHeader:
    "content-header bg-white py-5 px-8 rounded-[1.25rem] mb-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex justify-between items-center border border-[#ECE6E1] max-[1024px]:p-4 max-[1024px]:flex-col max-[1024px]:gap-4 max-[1024px]:items-start",
  ...
  sortSelect:
    "py-2 px-4 bg-white border border-border rounded-xl text-sm font-semibold cursor-pointer outline-none text-text-main appearance-auto",
  ...
  // Empty state
  emptyContainer:
    "py-24 px-8 text-center bg-white rounded-[1.5rem] border border-[#ECE6E1]",
  emptyIconWrapper:
...
export const propertyDetailsStyles = {
  ...
  wishlistButton: (isInWishlist) =>
    `wishlist-action-btn w-12 h-12 rounded-full border border-border bg-white flex items-center justify-center cursor-pointer transition-all duration-300 ease-in-out shadow-[0_4px_12px_rgba(0,0,0,0.1)] hover:scale-110 hover:shadow-[0_6px_16px_rgba(0,0,0,0.12)] hover:border-[#cbd5e1] ${isInWishlist ? "text-red-500" : "text-[#64748b]"}`,
  statsGrid:
    "stats-grid grid grid-cols-[repeat(auto-fit,minmax(100px,1fr))] gap-3 mb-10 max-[768px]:grid-cols-2 max-[480px]:gap-2",
  statCard:
    "py-4 px-2 bg-[#FCFAF8] rounded-2xl border border-[#ECE6E1] text-center min-w-0",
  ...
  sellerCard:
    "bg-white p-6 rounded-[1.5rem] border border-[#ECE6E1] shadow-[0_4px_20px_rgba(0,0,0,0.03)] min-w-0",
  ...
  inquiryTextarea:
    "w-full h-[100px] p-3 rounded-xl border border-border mb-4 outline-none resize-none text-[0.875rem] break-words whitespace-pre-wrap",
  ...
  inquiryDisabledMessage: "text-center p-4 bg-[#FCFAF8] rounded-xl",
  inquiryDisabledText:
    "text-[0.875rem] text-[#64748b] break-words whitespace-normal",
  inquiryLoginButton: "btn btn-primary mt-2 w-full block",
  additionalDetails:
    "additional-details bg-white p-8 rounded-[1.5rem] border border-[#ECE6E1] mt-12 min-w-0",
  detailsTitle: "text-xl font-bold mb-6 border-b border-[#ECE6E1] pb-3",
  detailsGrid:
    "details-grid-row grid grid-cols-2 gap-8 max-sm:grid-cols-1 max-sm:gap-0",
  detailRow:
    "flex justify-between gap-4 py-2 border-b border-dashed border-[#ECE6E1] min-w-0",
  detailLabel:
  ...
  similarEmptyState:
    "col-span-full p-12 bg-[#FCFAF8] rounded-[1.5rem] text-center border border-dashed border-border text-[#64748b] break-words whitespace-normal",
};
...
export const sellerProfileStyles = {
  ...
  // Profile header card
  profileCard:
    "bg-white rounded-3xl p-6 sm:p-10 shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-[#ECE6E1] mb-12 flex flex-wrap gap-10 items-center justify-center sm:justify-start text-center sm:text-left",
  avatarWrapper:
    "w-[150px] h-[150px] rounded-full overflow-hidden border-4 border-[#ECE6E1]",
  avatarImage: "w-full h-full object-cover",
  ...
  emptyProperties:
    "col-span-full p-12 bg-[#FCFAF8] rounded-3xl text-center border border-border",
};
...
export const adminSidebarStyles = {
  ...
  sidebar: (isOpen) =>
    `fixed left-0 top-0 w-[260px] h-screen bg-white border-r border-[#ECE6E1] py-8 px-5 flex flex-col z-[1000] transition-transform duration-300 ${
  ...
  navLink: (isActive) =>
    `flex items-center gap-4 py-3.5 px-4 rounded-xl no-underline text-[0.9375rem] transition-all duration-200 ease-[cubic-bezier(0.4,0,0.2,1)] ${
      isActive
        ...
        : "font-medium text-[#64748b] hover:bg-primary-light"
    }`,
  logoutContainer: "border-t border-[#ECE6E1] pt-6 mt-auto",
  logoutButton:
...
export const sellerSidebarStyles = {
  ...
  navLinkInactive: "font-medium text-[#64748b] hover:bg-primary-light",
...
export const logoStyles = {
  ...
  iconWrapper:
    "bg-primary text-white p-2 rounded-[10px] flex items-center justify-center shadow-[0_4px_12px_rgba(244,124,32,0.22)]",

  text: "tracking-[-0.02em] text-primary-dark font-extrabold",
};

export const navbarStyles = {
  nav: "bg-primary-light/95 fixed top-0 w-full left-0 z-[9000] py-2 lg:py-4",
  container: "container px-6 max-w-[1400px] mx-auto",
  grid: "grid grid-cols-[auto_1fr_auto] items-center gap-4",
  desktopMenu:
    "hidden lg:flex justify-self-center items-center bg-white/50 px-3 py-1.5 rounded-2xl border border-white/30 gap-2 shadow-[0_4px_15px_rgba(0,0,0,0.05)]",
  navLink:
    "nav-link text-text-main font-semibold text-[15px] px-10 py-2 rounded-2xl transition-all duration-300 no-underline hover:text-primary hover:bg-primary/20",
  navL:
    "nav-link font-semibold text-[15px] px-10 py-2 rounded-2xl transition-all duration-300 no-underline text-primary bg-primary/10 hover:bg-primary-dark/20 hover:text-primary-dark/90",  
  ...
  drawerHeader: "flex justify-between items-center mb-10 mt-15",
  drawerCloseIcon: "cursor-pointer text-text-main",
  drawerNavLinks: "flex flex-col gap-6 text-lg text-nowrap -mr-4",
...
export const propertyCardStyles = {
  // Card container
  card: "fade-in group flex flex-col bg-white rounded-[1.25rem] overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.05)] transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] border border-border relative w-full hover:-translate-y-2 hover:shadow-[0_12px_30px_rgba(0,0,0,0.1)] max-sm:max-w-[420px] max-sm:mx-auto",
  ...
  specsGrid:
    "grid grid-cols-[1fr_1fr_1fr] py-4 border-t border-[#ECE6E1] gap-2 mt-auto",
  ...
  specDivider: "border-l border-r border-[#ECE6E1]",
