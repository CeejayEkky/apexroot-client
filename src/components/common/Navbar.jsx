...
const Navbar = () => {
  ...
  const togMenu = () => setIsOpen(!isOpen);
        ...
        <div className={s.container}>
          <div className={s.grid}>
            ...
            <div className={s.rightSection}>
                ...
                <div className={s.userSection}>
                  <Link to="/profile" className="flex items-center">
                    <img
                      src={
                        user.profilePic ||
                        `https://ui-avatars.com/api/?name=${user.name}&background=6e2d0d&color=fff`
                      }
                      alt="Profile"
                      className={s.avatar}
                    />
              ...
              <div className={s.mobileToggle} onClick={togMenu}>
                {isOpen ? (
                  <HiX size={28} style={{ color: "orangered" }} />
                ) : (
                  <HiMenuAlt3 size={28} style={{ color: "brown" }} />
                )}
              </div>
            </div>
          </div>
            ...
            <div className={s.drawerUserSection}>
                <div className={s.drawerUserInfo}>
                    <img src={
                        user.profilePic || 
                        `https://ui-avatars.com/api/?name=${user.name}&background=6e2d0d&color=fff` 
                    } alt="Profile" className= {s.drawerAvatar} />
